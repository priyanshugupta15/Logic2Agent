        ...
        <div className="min-h-screen flex items-center justify-center bg-background px-4 py-12 relative overflow-hidden">
            ...
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    <h1 className="text-4xl font-black text-white mb-2 leading-tight">Welcome <span className="text-primary italic">Back</span></h1>
                    <p className="text-gray-400 text-sm tracking-wide uppercase font-bold opacity-70">Sign in to continue to <span className="text-accent underline decoration-accent/30">Logic2Agent</span></p>
                </div>
                ...
                <p className="text-center text-gray-500 text-sm mt-8">
                    ...
                    <a href="/sign-up" className="text-primary hover:text-primary font-black uppercase tracking-widest text-[10px] underline underline-offset-4 decoration-primary/30">
                        Sign up for free
                    </a>
                </p>
            </div>
